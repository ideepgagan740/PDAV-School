...
const data1= require('./database/data')
const chalk = require("chalk")
...
// app.post('/classUpdated',async (req, res) => {
//     console.log('inside class   u   pdated')
    
//         $(document).ready(function(){
            
//             $('#classSelected').change(function(){
//                 debugger
//                 $('#sectionSelected').html('<option selected> choose Section</option>')
//                 const section= data1.filter(m=>m.class1==$('#classSelected').val())
